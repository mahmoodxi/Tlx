...
ExecStart=/var/MTProxy/objs/bin/mtproto-proxy -u nobody -p 5000 -H 443 -S """+str(secret)+""" -P """+str(tag2)+""" -D """+str(tls)+""" --nat-info """+str(privfinish)+":"+str(ipfinish)+""" --aes-pwd proxy-secret proxy-multi.conf -M 4
Restart=on-failure
